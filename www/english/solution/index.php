<?php
	//301ページリダイレクト
	Header("Location: http://hermes.ne.jp/english/solution/software.html", true, 301);
	exit();

	$pageFile = "";
	$pageTitle= "";
	$defaultPageFile = "software.php";
	$defaultPageTitle = "Software Development";
	$pages = array(
	...
	$titles = array(
					...
					"assist" => "System Engineering Support",
					"average" => "Offshore Development",
					"translation" => "On-site Technical Translation",
					"capacity" => "capacity",
...
<?php } ?>
<title>Hermes Systems Inc - Business Lineup</title> 
</head>
<body>
	<!-- コンテナー -->
	<div id="container">
