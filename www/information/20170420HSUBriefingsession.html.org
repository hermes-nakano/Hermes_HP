...
<head>
    ...
    <title>Hermes Systems Inc. -HSU合同説明会</title>
...
<body>
    <div id="body-inner">
        ...
        <header class="clearfix">
            <!-- Header-bar -->
            <div id="header-bar">
                <a class="logo" href="../index.html"><img src="../img/logo_pc_off.png" alt="Hermes Systems Inc." style="visibility: visible;">
                </a>

                <!-- Sub-menu -->
                <div id="smenu">
                    <ul>
                        <li><a href="../sitemap/sitemap.html"><i class="fa fa-sitemap fa-fw"></i>サイトマップ</a>
                        </li>
                        <li><a href="../english/company/overview.html"><i class="fa fa-globe fa-fw"></i>English</a>
                        </li>
                    </ul>
                </div>
                <div id="smenu_2">
        ...
        <div id="breadcrumb-wrapper" class="clearfix">
            <nav id="breadcrumb">
                <ul>
                    ...
                    <li class="current"><a href="../information/information.html">お知らせ</a></li>
                </ul>
            </nav>
        </div>
        ...
        <main class="clearfix">
            <article>
                <section id="contents" class="responsive-article-wrapper">
                    <h1>HSU合同企業説明会 4/20(木)、21(金) 実施<span>　2019年春季　Hermes Systems Inc.</span></h1>
                    <section class="common-article-parent">
                        <p><br>
                        <p style="font-size:20px;color: #04335a; border: 4px #808080 double;width:550px;background-color: #f9ffea;">
                        <br>　2019年春季入社　社員募集中！<br><br>
                        　日本の情報社会基幹システム開発を担う当社に来たれ！<br><br><p>
                        
                        <h2><p style="font-size:20px;">HSU合同企業説明会（於：HSU本学体育館）</p></h2>
                        <p style="font-size:20px;">
                        日程　　　4/20(木)　13:00～19:00<br>
                        　　　　　4/21(金)　10:00～15:00<br>
                        <br>
                        皆様のご参加を心よりお待ちしております。<br>
                        </p>
                        <h2><p style="font-size:20px;">募　	集</p></h2>
                        <p style="font-size:20px;">
                        ＳＥ職　　　：70名<br>
                        英語専門職　：10名<br>
                        総合職　　　：10名<br>
                        ＨＳＵ　　　：枠無制限<br>
                        <br>
                        2017年12月に内定者研修を開始予定(16ヶ月間の費用給付つき研修)<br>
                        インターン生随時受付中です。
                        </p>
            ...
            <aside id="side-menu">
                <nav>
                    <ul>
                        <li class="top-category current"><a href="../information/information.html">お知らせ</a></li>
