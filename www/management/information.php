...
<table id ="secret_table" cellspacing="0" cellpadding="0">
	<!-- コンテンツタイトル枠 -->
	<tr>
		<td colspan=4 class="m_bar" style="width:540px;">お知らせ</td>
	</tr>
	<!-- 縦余白 -->
	<tr>
	...
	<!-- ファイル一覧読み込み -->
	<?php include "information_files.php"; ?>
	...
	<?php for($i=0; $i < count($files); $i++){ ?>
		<tr>
			...
			<td class="secret_cell2">
				...
				<?php }else{ ?>
				<a href="<?php echo $files[$i]["url"]; ?>" target="blank"><?php echo $files[$i]["title"]; ?></a>
				<?php } ?>
			</td>
			<!-- ファイルサイズ -->
			<td class="secret_cell3">
				<a href="<?php echo $files[$i]["url"]; ?>" target="blank"><?php echo $files[$i]["icon"]; ?></a>
			</td>
		</tr>
