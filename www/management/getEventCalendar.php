<?php
// 呼び出し用
function getEventCalendar($selectFromYear, $selectFromMonth, $selectFromDay, $selectToYear, $selectToMonth, $selectToDay){
	// 取得するカレンダーのIDを指定する
//	define('CALENDAR_ID','hermeigyo@gmail.com');
	define('CALENDAR_ID','2u935v20rb8ld4g85vb2muit7k@group.calendar.google.com');
	// 取得するカレンダーがひもづいたGoogleアカウントのAPIキーを指定する
	define('API_KEY', 'AIzaSyBVXI_YZBsioE4b832zH1z8Kz-x2J1ffJQ');
