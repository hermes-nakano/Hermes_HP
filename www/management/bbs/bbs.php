					...
					<tr>
						...
						<table  width="95%" border=0>
							<tr>
								<td>
					  			<center>
					  			<FONT SIZE="6" COLOR="#000099">社員専用掲示板</FONT><br><br>
								<!--<a href="../download.html"><font color="#000000">[社員専用TOP]</font></a>
								<font color="#000000">|</font>-->
								<a href="bbs.php"><font color="#000000">[掲示板TOP]</font></a>
								<font color="#000000">|</font>
								<a href="online.html"><font color="#000000">[利用方法]</font></a><BR><br>
END;
$footer =<<<END
								</center>
					 			</td>
...
<!- 掲示板の使い方 ->
	...
	<br><br>
	<FONT SIZE="6" COLOR="#000099">掲示板の利用方法</FONT><br>
	<br>
	【記事作成】<br>
	<br>
	下記項目を入力し、「記事作成」をクリックすると親記事が作成されます。
　	<li>名前（必須）：氏名を入力して下さい。
　	<li>題名：何をあげるのか、何が欲しいのかわかる<br>　 ように入力して下さい。
　	<li>メール：自身のメールアドレスを入力して下さ<br>　 い。
	<li>内容（必須）：投稿内容を入力して下さい。
	<li>ファイル：右側の参照をクリックして、画像フ<br>　 ァイル（JPG,GIF,PNG）を選択して下さい。
	<li>パスワード（必須）：記事を削除する際に必要<br>　 です。
	<br><br>
	【返信】<br>
	「全て表示」をクリックすると親記事に対する返信コメントを表示します。<br>
	記事作成と同様に項目を入力し、「返信する」をクリックすると返信記事が作成され、掲示板TOPへ移動します。<br>
	<br>
	【記事削除】<br>
	削除したい記事の番号とパスワードを入力し「削除」をクリックすると記事が削除されます。<br>
	<br>
	【メール送信】<br>
	記事作成においてメールアドレスを入力した場合に投稿者名の右に表示される<br>
	[メール]をクリックするとメールソフトが起動します。<br>
	<br>
	</td></tr>
</table>
...
function _form_show($res_title="", $hidden="")
{
	...
	<div align="right">投稿者名<font color="#ff0000">(必須)</font><input type="text" name="name" size="40" value="'.$v['name'].'"></div>
	...
	<div align="right">投稿内容の題名<input type="text" name="title" size="40" value="'.$res_title.'" ></div>
	<div style="position:absolute;">
	...
	<div align="right">投稿者のメールアドレス<input type="text" name="email" size="40" value="'.$v['email'].'"></div>
	<div style="position:absolute;">
	...
	//本文
	//複数行の入力欄は、<textarea>～</textarea> です。横幅のサイズを、cols="46" にする。
	//縦幅のサイズを、rows="5" にする。コメント用の入力欄なので、名前を、mes にする。
	
	$str .= '<tr><td align="right">
	<div align="right">投稿する本文<font color="#ff0000">(必須)</font>
	</td></tr>'."\n";
	$str .= '<tr><td align="right" onMouseover="mOver(3)" onMouseout="mOut()" bgcolor="#ffffff">
	<div align="right"><textarea name="mes" cols="46" rows="5" wrap="soft"></textarea></div>
	<div style="position:absolute;">
	...
	border-width:2px 2px 2px 2px;">
	<div align="left">
	(例)新しく液晶テレビを買うことにしたので、必要な方がいたらあげます。
	</div></div></div>
	</td></tr>'."\n";
...
{
	global $colors,$icons; // $colors を _table 関数内で使えるように global 宣言。初期設定で指定した $icons が _table 関数内で使えるように global 宣言する。
	...
	// アイコン
		...
		$icon_show = '<img src="'.DE_IMG_DIR.$icons[$icon].'" align="left">'; // img タグにアイコンパスを指定したものを $icon_show に代入する。
	}
