        ...
        <main class="clearfix">
            <article>
                <section id="contents" class="responsive-list-wrapper">
                    ...
                    <form name="entryForm" method="post" action="./sendEntryMail.php">
                        <?php
                            if(!empty($_errors)){
                        ...
                        <dl class="responsive-list">
                            ...
                            <!--  希望職種 -->
                            <dt><font class="require">希望職種</font></dt> 
                            <dd>
                            ...
                            <!-- 氏名(全角) -->
                            <dt><font class="require">氏名(全角)</font></dt>
                            ...
                            <!-- 氏名(かな) -->
                            <dt><font class="require">かな(全角)</font></dt>
                            ...
                            <!-- 年齢 -->
                            <dt><font class="require">年齢</font></dt>
                            <dd>
                            ...
                            <!-- 性別 -->
                            <dt><font class="require">性別</font></dt>
                            <dd>
                            ...
                            <!-- 住所 -->
                            <dt><font class="require">住所(全角)</font></dt>
                            ...
                            <!-- 電話番号 -->
                            <dt><font class="require">電話番号(半角)</font></dt>
                            ...
                            <!-- 電子メール -->
                            <dt><font class="require">メールアドレス(半角)</font></dt>
                            ...
                            <!-- 学歴1 -->
                            <dt><font class="require">学歴1(全角)</font></dt>
                            <dd>
                            ...
                            <!-- 採用試験希望日時 -->
                            <dt><font color="red">採用試験<br>希望日時</font></dt>
