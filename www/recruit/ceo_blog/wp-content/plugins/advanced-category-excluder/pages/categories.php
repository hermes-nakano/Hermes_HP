<?php
    ...
    if ($_POST['submit'] && !empty($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'],'categories_settings') )
    ...
    if ($_POST['empty'] && !empty($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'],'categories_settings')  )
    {
    	foreach ($ace_targets as $key=>$val)
    	{
...
<div class="wrap">
  ...
  <form method="post">
    <?php
	wp_nonce_field( 'categories_settings', '_wpnonce', false );
    ?>
