		...
		<main class="clearfix">
			<article>
				<section id="contents" class="responsive-article-wrapper">
					<h1>採用活動スケジュール<span>2018年採用活動スケジュール</span></h1>
			...
			<aside id="side-menu">
				<nav>
					<ul>
						...
						<li class="current"><a href="../recruit/schedule_2018.php">2018年採用活動スケジュール</a></li>
						<li><a href="../recruit/schedule.php">2017年採用活動スケジュール</a></li>
						<li><a href="../recruit/schedule_2016.php">2016年採用活動スケジュール</a></li>
